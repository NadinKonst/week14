...
const myInformation = ["Nadya", 23, 6, "Cancer"];
...
function sortAndPrint() {
  let spreadRandomNumbers = [...randomNumbers];
  return spreadRandomNumbers.sort((a, b) => a - b);
}
console.log(sortAndPrint());

// Или так:
// let spreadRandomNumbers = [...randomNumbers];
// console.log(spreadRandomNumbers.sort((a, b) => a - b));
